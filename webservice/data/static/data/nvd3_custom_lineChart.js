    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            else
            {
                ...
                // Use global data2 attribute to show different data.
                var contextLinesWrap = g.select('.nv-context .nv-linesWrap')
                    .datum(data2.filter(function(d) { return !d.disabled; }))
                    ;
            ...
            function onBrush() {
                ...
                )
                {
                        ...
                        if(rangeStart.isBefore(currentRange.start, 'days')){
                            start = rangeStart;
